	...
	return (
		<>
			<Head>
				...
				<meta name="description" content="Your privacy is important to us. Read our privacy policy to find out how we handle your personal information." />
				<meta name="og:description" content="Your privacy is important to us. Read our privacy policy to find out how we handle your personal information." />
				<meta name="twitter:description" content="Your privacy is important to us. Read our privacy policy to find out how we handle your personal information." />
			...
			<main className="container mx-auto">
				<h2 className="text-center my-8 font-spartanExtraBold text-pw-blue">
					<b>PRIVACY POLICY</b>
				</h2>
				<p className="font-spartanBold text-pw-blue">Effective date: 2022-12-28</p>
				<p className="mt-4 mb-2 font-spartanMedium text-pw-blue">
					1. <b className="font-spartanBold">Introduction</b>
				</p>
				<p className="ml-7 font-spartanRegular text-pw-blue">
					Welcome to <b className="font-spartanBold"> brianwachira</b>.
				</p>
				<p className="ml-7 text-pw-blue">
					<b className="font-spartanBold">brianwachira</b> (“us”, “we”, or
					“our”) operates <b className="font-spartanBold">brianwachira.dev</b>{" "}
				...
				<p className="ml-7 font-spartanRegular text-pw-blue">
					Our Terms and Conditions (<b className="font-spartanBold">“Terms”</b>)
				...
				<p className="ml-7 font-spartanRegular text-pw-blue">
					<b className="font-spartanBold">SERVICE</b> means the brianwachira.dev
					website operated by brianwachira.
				</p>
				<p className="ml-7 font-spartanRegular text-pw-blue">
					<b className="font-spartanBold">PERSONAL DATA</b> means data about a
				...
				<p className="ml-7 font-spartanRegular text-pw-blue">
					<b className="font-spartanBold">USAGE DATA</b> is data collected
					automatically either generated by the use of Service or from Service
					infrastructure itself (for example, the duration of a page visit).
				</p>
				<p className="ml-7 font-spartanRegular text-pw-blue">
					<b className="font-spartanBold">COOKIES</b> are small files stored on
					your device (computer or mobile device).
				</p>
				<p className="ml-7 font-spartanRegular text-pw-blue">
					<b className="font-spartanBold">DATA CONTROLLER</b> means a natural or
				...
				<p className="ml-7 font-spartanRegular text-pw-blue">
					<b className="font-spartanBold">DATA SUBJECT</b> is any living
					individual who is the subject of Personal Data.
				</p>
				<p className="ml-7 font-spartanRegular text-pw-blue">
					<b className="font-spartanBold">THE USER</b> is the individual using
				...
				<p className="ml-7 font-spartanMedium text-pw-blue">
					<b className="font-spartanBold">Personal Data</b>
				</p>
				<p className="ml-10 font-spartanRegular text-pw-blue">
					While using our Service, we may ask you to provide us with certain
					personally identifiable information that can be used to contact or
					identify you (<b className="font-spartanBold">“Personal Data”</b>).
					Personally identifiable information may include, but is not limited
					to:
				</p>
				<p className="ml-12 font-spartanMedium text-pw-blue">0.1. Email address</p>
				<p className="ml-12 font-spartanMedium text-pw-blue">
					0.2. First name and last name
				</p>
				<p className="ml-12 font-spartanMedium text-pw-blue">0.5. Cookies and Usage Data</p>
				<p className="ml-12 font-spartanRegular text-pw-blue">
				...
				<p className="ml-10 font-spartanRegular text-pw-blue">Examples of Cookies we use:</p>
				<p className="ml-12 font-spartanMedium text-pw-blue">
					0.1. <b className="font-spartanBold">Session Cookies:</b> We use
					Session Cookies to operate our Service.
				</p>
				<p className="ml-12 font-spartanMedium text-pw-blue">
					0.2. <b className="font-spartanBold">Preference Cookies:</b> We use
					Preference Cookies to remember your preferences and various settings.
				</p>
				<p className="ml-12 font-spartanMedium text-pw-blue">
					0.3. <b className="font-spartanBold">Security Cookies:</b> We use
					Security Cookies for security purposes.
				</p>
				<p className="mt-4 mb-2 font-spartanRegular text-pw-blue">
					5. <b className="font-spartanBold">Use of Data</b>
				</p>
				<p className="ml-7 font-spartanRegular text-pw-blue">
					brianwachira uses the collected data for various purposes:
				</p>
				<p className="ml-10 font-spartanMedium text-pw-blue">
				...
				<p className="ml-10 font-spartanMedium text-pw-blue">
					...
					to those that you have enquired about unless you have opted not to
					receive such information;
				</p>
				<p className="ml-10 font-spartanMedium text-pw-blue">
					0.10. in any other way we may describe when you provide the
					information;
				</p>
				<p className="ml-10 font-spartanMedium text-pw-blue">
				...
				<p className="ml-7 font-spartanRegular text-pw-blue">
					brianwachira will take all the steps reasonably necessary to ensure
				...
				<p className="ml-7 font-spartanMedium text-pw-blue">
					0.1.{" "}
					<b className="font-spartanBold">Disclosure for Law Enforcement.</b>
				</p>
				<p className="ml-10 font-spartanRegular text-pw-blue">
				...
				<p className="ml-10 font-spartanMedium text-pw-blue">
					...
					us at <b>brianwachira7@gmail.com</b>.
				</p>
				<p className="mt-4 mb-2 ml-7 font-spartanMedium text-pw-blue">
				...
				<p className="ml-7 font-spartanRegular text-pw-blue">
					...
					(<b className="font-spartanBold">“Child”</b> or{" "}
					<b className="font-spartanBold">“Children”</b>).
				</p>
				<p className="ml-7 font-spartanRegular text-pw-blue">
				...
				<p
					className="ml-7 font-spartanRegular text-pw-blue"
					style={{ marginTop: "5em", fontSize: "0.7em" }}
				>
					This{" "}
					<Link
						className=" font-spartanBold  text-pw-orange"
						href="https://policymaker.io/privacy-policy/"
					>
						Privacy Policy
					</Link>{" "}
					was created for <b className="font-spartanBold">brianwachira.dev</b>{" "}
					by{" "}
					<Link
						className=" font-spartanBold  text-pw-orange"
