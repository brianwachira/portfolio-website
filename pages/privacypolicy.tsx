...
const Privacypolicy = () => {
	return (
		<main className="container mx-auto">
			<h2 className="text-center my-8 font-spartanExtraBold">
				<b>PRIVACY POLICY</b>
			</h2>
			<p className="font-spartanBold">Effective date: 2022-12-28</p>
			<p className="mt-4 mb-2 font-spartanMedium">
				1. <b className="font-spartanBold">Introduction</b>
			</p>
			<p className="ml-7 font-spartanRegular">
				Welcome to <b className="font-spartanBold"> brianwachira</b>.
			</p>
			<p className="ml-7">
				<b className="font-spartanBold">brianwachira</b> (“us”, “we”, or “our”) operates{" "}
				<b className="font-spartanBold">brianwachira.dev</b> (hereinafter referred to as <b>“Service”</b>).
			</p>
			<p className="ml-7 font-spartanRegular">
				Our Privacy Policy governs your visit to <b>brianwachira.dev</b>, and
			...
			<p className="ml-7 font-spartanRegular">
				Our Terms and Conditions (<b className="font-spartanBold">“Terms”</b>) govern all use of our Service
				and together with the Privacy Policy constitutes your agreement with us
				(<b className="font-spartanBold">“agreement”</b>).
			</p>
			<p className="mt-4 mb-2 font-spartanMedium">
				2. <b className="font-spartanBold">Definitions</b>
			</p>
			<p className="ml-7 font-spartanRegular">
				<b className="font-spartanBold">SERVICE</b> means the brianwachira.dev website operated by
				brianwachira.
			</p>
			<p className="ml-7 font-spartanRegular">
				<b className="font-spartanBold">PERSONAL DATA</b> means data about a living individual who can be
			...
			<p className="ml-7 font-spartanRegular">
				<b className="font-spartanBold">USAGE DATA</b> is data collected automatically either generated by
				the use of Service or from Service infrastructure itself (for example,
				the duration of a page visit).
			</p>
			<p className="ml-7 font-spartanRegular">
				<b className="font-spartanBold">COOKIES</b> are small files stored on your device (computer or mobile
				device).
			</p>
			<p className="ml-7 font-spartanRegular">
				<b className="font-spartanBold">DATA CONTROLLER</b> means a natural or legal person who (either alone
			...
			<p className="ml-7 font-spartanRegular">
				<b className="font-spartanBold">DATA PROCESSORS (OR SERVICE PROVIDERS)</b> means any natural or legal
			...
			<p className="ml-7 font-spartanRegular">
				<b className="font-spartanBold">DATA SUBJECT</b> is any living individual who is the subject of
				Personal Data.
			</p>
			<p className="ml-7 font-spartanRegular">
				<b className="font-spartanBold">THE USER</b> is the individual using our Service. The User
				corresponds to the Data Subject, who is the subject of Personal Data.
			</p>
			<p className="mt-4 mb-2 font-spartanMedium">
				3. <b className="font-spartanBold">Information Collection and Use</b>
			</p>
			<p className="ml-7 font-spartanRegular">
			...
			<p className="mt-4 mb-2 font-spartanMedium">
				4. <b className="font-spartanBold">Types of Data Collected</b>
			</p>
			<p className="ml-7 font-spartanMedium">
				<b className="font-spartanBold">Personal Data</b>
			</p>
			<p className="ml-10 font-spartanRegular">
				While using our Service, we may ask you to provide us with certain
				personally identifiable information that can be used to contact or
				identify you (<b className="font-spartanBold">“Personal Data”</b>). Personally identifiable
				information may include, but is not limited to:
			</p>
			<p className="ml-12 font-spartanMedium">0.1. Email address</p>
			<p className="ml-12 font-spartanMedium">0.2. First name and last name</p>
			<p className="ml-12 font-spartanMedium">0.5. Cookies and Usage Data</p>
			<p className="ml-12 font-spartanRegular">
			...
			<p className="ml-7 font-spartanMedium">
				<b className="font-spartanBold">Usage Data</b>
			</p>
			<p className="ml-10 font-spartanRegular">
			...
			<p className="ml-7">
				<b className="font-spartanBold">Tracking Cookies Data</b>
			</p>
			<p className="ml-10 font-spartanRegular">
			...
			<p className="ml-10 font-spartanRegular">Examples of Cookies we use:</p>
			<p className="ml-12 font-spartanMedium">
				0.1. <b className="font-spartanBold">Session Cookies:</b> We use Session Cookies to operate our
				Service.
			</p>
			<p className="ml-12 font-spartanMedium">
				0.2. <b className="font-spartanBold">Preference Cookies:</b> We use Preference Cookies to remember
				your preferences and various settings.
			</p>
			<p className="ml-12 font-spartanMedium">
				0.3. <b className="font-spartanBold">Security Cookies:</b> We use Security Cookies for security
				purposes.
			</p>
			<p className="mt-4 mb-2 font-spartanRegular">
				5. <b className="font-spartanBold">Use of Data</b>
			</p>
			<p className="ml-7 font-spartanRegular">brianwachira uses the collected data for various purposes:</p>
			<p className="ml-10 font-spartanMedium">0.1. to provide and maintain our Service;</p>
			<p className="ml-10 font-spartanMedium">0.2. to notify you about changes to our Service;</p>
			<p className="ml-10 font-spartanMedium">
				0.3. to allow you to participate in interactive features of our Service
				when you choose to do so;
			</p>
			<p className="ml-10 font-spartanMedium">0.4. to provide customer support;</p>
			<p className="ml-10 font-spartanMedium">
				0.5. to gather analysis or valuable information so that we can improve
				our Service;
			</p>
			<p className="ml-10 font-spartanMedium">0.6. to monitor the usage of our Service;</p>
			<p className="ml-10 font-spartanMedium">0.7. to detect, prevent and address technical issues;</p>
			<p className="ml-10 font-spartanMedium">0.8. to fulfil any other purpose for which you provide it;</p>
			<p className="ml-10 font-spartanMedium">
				0.9. to provide you with news, special offers and general information
				about other goods, services and events which we offer that are similar
				to those that you have enquired about unless you
				have opted not to receive such information;
			</p>
			<p className="ml-10 font-spartanMedium">
				0.10. in any other way we may describe when you provide the information;
			</p>
			<p className="ml-10 font-spartanMedium">0.13. for any other purpose with your consent.</p>
			<p className="mt-4 mb-2 font-spartanRegular">
				6. <b className="font-spartanBold">Retention of Data</b>
			</p>
			<p className="ml-7 font-spartanRegular">
			...
			<p className="mt-4 mb-2 font-spartanMedium">
				7. <b className="font-spartanBold">Transfer of Data</b>
			</p>
			<p className="ml-7 font-spartanRegular">
			...
			<p className="ml-7 font-spartanRegular">
				...
				Personal Data, to Kenya and process it there.
			</p>
			<p className="ml-7 font-spartanRegular">
			...
			<p className="ml-7 font-spartanRegular">
				brianwachira will take all the steps reasonably necessary to ensure that
			...
			<p className="mt-4 mb-2 font-spartanMedium">
				8. <b className="font-spartanBold">Disclosure of Data</b>
			</p>
			<p className="ml-7 font-spartanRegular">
				We may disclose personal information that we collect, or you provide:
			</p>
			<p className="ml-7 font-spartanMedium">
				0.1. <b className="font-spartanBold">Disclosure for Law Enforcement.</b>
			</p>
			<p className="ml-10 font-spartanRegular">
			...
			<p className="ml-7 font-spartanMedium">
				0.2. <b className="font-spartanBold">Business Transaction.</b>
			</p>
			<p className="ml-10 font-spartanRegular">
			...
			<p className="ml-7 font-spartanMedium">
				0.3. <b className="font-spartanBold">Other cases. We may disclose your information also:</b>
			</p>
			<p className="ml-10 font-spartanMedium">0.3.1. to our subsidiaries and affiliates;</p>
			<p className="ml-10 font-spartanMedium">
				0.3.2. to contractors, service providers, and other third parties we use
				to support our business;
			</p>
			<p className="ml-10 font-spartanMedium">0.3.3. to fulfill the purpose for which you provide it;</p>
			<p className="ml-10 font-spartanMedium">
			...
			<p className="ml-10 font-spartanMedium">0.3.6. with your consent in any other cases;</p>
			<p className="ml-10 font-spartanMedium">
			...
			<p className="mt-4 mb-2 font-spartanMedium">
				9. <b className="font-spartanBold">Security of Data</b>
			</p>
			<p className="ml-7 font-spartanRegular">
			...
			<p className="ml-7 font-spartanRegular">
				...
				<b className="font-spartanBold">brianwachira7@gmail.com</b>.
			</p>
			<p className="ml-7 font-spartanRegular">
			...
			<p className="ml-7 font-spartanRegular">According to CalOPPA we agree to the following:</p>
			<p className="ml-10 font-spartanMedium">0.1. users can visit our site anonymously;</p>
			<p className="ml-10 font-spartanMedium">
			...
			<p className="ml-10 font-spartanMedium">
				...
				at <b>brianwachira7@gmail.com</b>.
			</p>
			<p className="mt-4 mb-2 ml-7 font-spartanMedium">Our Policy on “Do Not Track” Signals:</p>
			<p className="ml-10 font-spartanRegular">
			...
			<p className="ml-10 font-spartanRegular">
				...
				please send your request(s) by email: <b>brianwachira7@gmail.com</b>.
			</p>
			<p className="ml-10 font-spartanRegular">
			...
			<p className="mt-4 mb-2 font-spartanMedium">
				13. <b className="font-spartanBold">Service Providers</b>
			</p>
			<p className="ml-7 font-spartanRegular">
			...
			<p className="mt-4 mb-2 font-spartanMedium">
				14. <b className="font-spartanBold">Analytics</b>
			</p>
			<p className="ml-7 font-spartanRegular">
			...
			<p className="mt-4 mb-2 font-spartanMedium">
				15. <b className="font-spartanBold">CI/CD tools</b>
			</p>
			<p className="ml-7 font-spartanRegular">
			...
			<p className="mt-4 mb-2 font-spartanMedium">
				16. <b className="font-spartanBold">Behavioral Remarketing</b>
			</p>
			<p className="ml-7 font-spartanRegular">
			...
			<p className="mt-4 mb-2 font-spartanMedium">
				17. <b className="font-spartanBold">Links to Other Sites</b>
			</p>
			<p className="ml-7 font-spartanRegular">
			...
			<p className="mt-4 mb-2 font-spartanMedium">
				18.{" "}
				<b>
					<b className="font-spartanBold">Children’s Privacy</b>
				</b>
			</p>
			<p className="ml-7 font-spartanRegular">
				Our Services are not intended for use by children under the age of 18 (
				<b className="font-spartanBold">“Child”</b> or <b className="font-spartanBold">“Children”</b>).
			</p>
			<p className="ml-7 font-spartanRegular">
			...
			<p className="mt-4 mb-2 font-spartanMedium">
				19. <b className="font-spartanBold">Changes to This Privacy Policy</b>
			</p>
			<p className="ml-7 font-spartanRegular">
			...
			<p className="mt-4 mb-2 font-spartanMedium">
				20. <b className="font-spartanBold">Contact Us</b>
			</p>
			<p className="ml-7 font-spartanRegular">
				If you have any questions about this Privacy Policy, please contact us
				by email: <b className="font-spartanBold">brianwachira7@gmail.com</b>.
			</p>
			<p className="ml-7 font-spartanRegular" style={{ marginTop: "5em", fontSize: "0.7em" }}>
				This <Link className=" font-spartanBold  text-pw-orange" href="https://policymaker.io/privacy-policy/">Privacy Policy</Link>{" "}
				was created for <b className="font-spartanBold">brianwachira.dev</b> by{" "}
				<Link className=" font-spartanBold  text-pw-orange"  href="https://policymaker.io">PolicyMaker.io</Link> on 2022-12-28.
			</p>
		</main>
	);
};
