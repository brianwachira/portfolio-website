...
const NavBar = () => {
	...
	return (
		<nav className={`px-2 py-2 sm:px-4 fixed w-full z-20 top-0 left-0  transition delay-150 duration-300 ease-in-out bg-pw-blue ${scrollPosition > 500 ? 'md:bg-pw-blue' : 'md:bg-transparent'}`}>
			<div className="lg:mx-auto container flex flex-wrap items-center justify-between">
				...
				<div
					className={`${navIsOpen === true ? '' : 'hidden'} items-center justify-between  w-full md:flex md:w-auto md:order-1`}
					id="navbar-sticky"
				>
